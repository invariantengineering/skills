...
| [estimate-time-and-tokens](estimate-time-and-tokens/) | productivity | Forecast time, tokens, files, and diff size, then calibrate estimates against completed work. |
